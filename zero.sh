...
ADMIN_WHATSAPP_NUMBER="081311976463"
...
echo -e "\033[32mWHATSAPP RAYAXD : 081311976463\033[0m"
echo -e "\033[31mTELEGRAM : t.me/RayaaOfc\033[0m"
echo -e "${RED} © RAYAXD-DEVELOPER"
echo ""
...
# Masukkan token GitHub langsung di sini
  ...
  cd /var/www/ && rm -r installer-theme
...
if [ $? -eq 0 ]; then
    ...
    echo "TERJADI KESALAHAN SAAT MEMPERBARUI FILE!! SILAHKAN HUBUNGI 081311976463 UNTUK MEMINTA BANTUAN"
fi
 ;;
    5)
     # Masukkan token GitHub langsung di sini
